(function($, Drupal) {
  ...
  $('#menu-main').on('click', '.form-actions', function(e) {
    $('#menu-main').toggleClass('show-search').find('.form-search').focus();
  ...
  if (window.matchMedia("(max-width: 768px)").matches) {
    var open = $('#menu-main .dropdown-toggle'),
    ...
    open.click(function(e) {
      ...
      if ($this.hasClass('active-menu') === true) {
        $this.removeClass('active-menu').next('.dropdown-menu').slideUp(speed);
      } else if (a.hasClass('active-menu') === false) {
        $this.addClass('active-menu').next('.dropdown-menu').slideDown(speed);
      } else {
        a.removeClass('active-menu').next('.dropdown-menu').slideUp(speed);
        $this.addClass('active-menu').next('.dropdown-menu').delay(speed).slideDown(speed);
      }
    });
  };
  ////////////////////////////////////////////////////////////////////////////////
  ...
  // [ MODAL ]
  $(function() {
    $('#bs-modal').on('shown.bs.modal', function() {
  ...
  $(function() {
    var logo = $("#header-menu .navbar-brand");
