...
[Barrio](https://www.drupal.org/project/bootstrap_barrio) propose a
 sophisticated configuration of Bootstrap **components/layout** and
 **color/font** in the theme configuration. This can be out of scope for normal
  users and also a constraint for developpers who want to have full control on
   the front end developement with the twig template and SCSS files like this
...
## FORM PLACEHOLDER
  ...
  This is the list of ID to add in the text area **Include text fields matching
