...
CUSTOMIZING
============
You can customize this theme with and whitout subtheme.

## WITHOUT SUBTHEME

### CSS
There is a CSS file at `assets/css/style-custom.css`  for you to add your custom CSS 

### SCSS
There is a SCSS template for you to add your custom CSS without subtheme.
...
## WITH SUBTHEME
Copy the `bfd_subtheme` folder to `/sites/themes/custom`. If you are using a multisites Drupal instance you have also to copy the `Bootstrap for drupal` base theme to your site specific folder or change the relative path in the SCSS master file - `bfd_subtheme/assets/scss/style.scss`.

### CSS
There is a CSS file at `bfd_subtheme/assets/css/style-custom.css`  for you to add your custom CSS 

###SCSS
You can theme with  SCSS by adding SCSS files to the master SCSS file `bfd_subtheme/assets/scss/tools/_subtheme.scss`. Gulp file is provided
